...
DATABASES['default'] = dj_database_url.parse(
    os.getenv('DATABASE_URL', '{% if cookiecutter.postgis == 'True' %}postgis{% else %}postgres{% endif %}://postgres:postgres@postgres:5432/{{ cookiecutter.pg_db }}'),
    conn_max_age=600,
...
try:
    ...
    print("Did not find Heroku settings. Skipping...")

try:
    from compressor_settings import *
except ImportError:
    print("Do not find Django Compressor settings. Skipping...")

try:
    from wagtail_settings import *
except ImportError:
    print("Did not find Wagtail settings. Skipping...")
